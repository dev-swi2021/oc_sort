...
def main(exp, args, num_gpu):
    ...
    elif exp.val_ann == "val_ccd.json":
        gt_type = 'Vis'
        seqs = "CAMEL-val_ccd"
    elif exp.val_ann == "val_ir.json":
        gt_type = 'IR'
        seqs = "CAMEL-val_ir"
    else:
        assert 0
    ...
    *_, summary = evaluator.evaluate_ocsort(
    ...
    gtfiles = glob.glob(
        # os.path.join("/media/a2mind/Backup/OC_SORT_datasets/MOT20/test", "*/gt/gt{}.txt".format(gt_type))
        os.path.join("/media/a2mind/Backup/OC_SORT_datasets/camel_dataset/val", "*/*-{}.txt".format(gt_type))
    )
